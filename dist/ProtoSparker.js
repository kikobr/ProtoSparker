...
var ProtoSparker = (function () {
	...
	= TODO LIST
	*/
	var _findAll, _getHierarchy, _match, f, ff, filter, find, includes, merge, parse, timeDefault, timeFast, transitions;
	...
	exports.ProtoSparker = (function() {
	  class ProtoSparker {
	    constructor(options1 = {}) {
	      ...
	      this.options.textField = merge(this.defaultTextField, this.options.textField);
	      if ((base2 = this.options).selectField == null) {
	        base2.selectField = {};
	      }
	      this.options.selectField = merge(this.defaultSelectField, this.options.selectField);
	      this.actions = [
	        {
	          selector: "goback",
	          fn: this.goBack
	    ...
	    generateFields() {
	      ...
	      return ff('select-field*,select_field*').forEach((field, index) => {
	    ...
	    generateScrolls() {
	      return ff('scroll*').forEach((layer) => {
	    ...
	    generateElements() {
	      return ff('*element:*').forEach((element) => {
	...
	f = exports.f = function(selector, fromLayer) {
	  return _findAll(selector, fromLayer)[0];
	};

	ff = exports.ff = function(selector, fromLayer) {
	  return _findAll(selector, fromLayer);
	};
	});
	var core_1 = core.parse;
	var core_2 = core.ProtoSparker;
	var core_3 = core.f;
	var core_4 = core.ff;
