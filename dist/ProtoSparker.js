...
var PS = (function (exports) {
	...
	var traverse_1 = traverse = function(node, parent, parentLayer) {
	  var ancestor, child, clipPath, clipPathBBox, clipPathBounds, clipPathInner, clipSelector, computedStyle, createdLayer, def, defs, e, i, importId, inner, isFirefox, j, k, l, layer, layerDefs, layerParams, layerSvg, len, len1, len2, len3, len4, m, mask, maskSelector, n, name, nodeBBox, nodeBounds, path, ref1, ref2, ref3, results, style, svg, url, viewBox;
	  ...
	  if (!isFirefox && (node.hasAttribute('clip-path') || (computedStyle.clipPath && computedStyle.clipPath !== 'none'))) {
	    ...
	    clipPathInner = clipPath.querySelector(':scope > *');
